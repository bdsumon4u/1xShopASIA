@if ($offlineIndicator)
    <div wire:offline.class="block" wire:offline.class.remove="hidden" class="hidden flex justify-center items-center m-1 font-medium py-1 px-2 bg-white rounded-md text-red-700 bg-red-100 border border-red-300 ">
        <div slot="avatar">
